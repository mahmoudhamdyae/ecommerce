...
class AppLocal extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    'ar': {
      ...
      AppStrings.resetTitle: 'إستعادة كلمة المرور',
      AppStrings.resetDesc: 'برجاء ادخال رقم الجوال الخاص بك',
      AppStrings.resetButton: 'استرجاع كلمة المرور',
      AppStrings.resetHead: 'نسيت كلمة المرور',
    ...
    'en': {
      ...
      AppStrings.wrongPhoneOrPassword: 'Wrong phone number or password',
      AppStrings.createAccountLabel: 'Create an account',
      AppStrings.resetTitle: 'إستعادة كلمة المرور',
      AppStrings.resetDesc: 'برجاء ادخال رقم الجوال الخاص بك',
      AppStrings.resetButton: 'استرجاع كلمة المرور',
      AppStrings.resetHead: 'Forgot password',
      ...
      AppStrings.notGetCode: 'لم تستلم الكود؟',
      AppStrings.codeResend: 'تم إرسال الكود مرة أخرى',
      AppStrings.userNameInvalid: 'Username can\'t be empty',
      AppStrings.emailInvalid: 'Email can\'t be empty',
      AppStrings.passwordConfirmInvalid: 'كلمة المرور غير متطابقة',
      AppStrings.passwordConfirm: 'تأكيد كلمة السر',
      ...
      AppStrings.userTypeConfirm: 'Confirm',
      AppStrings.pleaseLogIn: 'You should be logged in first',
      ...
      AppStrings.byPrice: 'حسب السعر',
      AppStrings.byEvaluation: 'حسب التقييم',
      AppStrings.showResults: 'Implementation',
      AppStrings.reset: 'Reset',
      AppStrings.serverDown: 'Server down',
      AppStrings.noInternetError: 'No internet connection',
      AppStrings.loading: 'Loading...',
      AppStrings.retryAgain: 'retry again',
      AppStrings.errorDialogTitle: 'Error!',
      AppStrings.addedFavSnackBar: 'added to favourites',
      AppStrings.removeFavSnackBar: 'removed from favourites',
      AppStrings.noFav: 'no products in favourites',
      AppStrings.noCart: 'no products in cart',
      AppStrings.noOrders: 'There is no orders',
      AppStrings.order: 'Order',
      AppStrings.orderConfirm: 'Confirm',
      AppStrings.firstNameHint: 'First Name',
      AppStrings.firstNameError: 'First name can\'t be empty',
      AppStrings.lastNameHint: 'Last name',
      AppStrings.lastNameError: 'Last name can\'t be empty',
      AppStrings.addressHint: 'Address',
      AppStrings.addressError: 'Address name can\'t be empty',
      AppStrings.finishOrder: 'Finish order',
      AppStrings.pay: 'الدفع عند الاستلام',
      AppStrings.visa: 'الدفع بالفيزا',
      AppStrings.orderDetails: 'Order Summary',
      AppStrings.orderDilivary: 'Dilivary',
      AppStrings.orderDiscount: 'Discount',
      AppStrings.orderTotal: 'Total',
      AppStrings.orderTotal2: 'grand total',
      AppStrings.pound: 'pound',
    }
  };
}